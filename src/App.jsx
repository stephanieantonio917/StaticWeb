      ...
      <div className="App">
        ...
        <main>
          <Section title="Highlights">
            ...
            <ul>
              <li>
                <b>Feb 7:</b> Employee Hack-a-ston
              </li>
              <li>
                <b>Mar 7:</b> Food Bank Volunteering
              </li>
              <li>
                <b>Apr 4:</b> Company Retreat
              </li>
            </ul>
          </Section>
          ...
          <Section title="Latest Event">
            <p>
              ...
              animi laudantium eos atque sed debitis eum deleniti cumque saepe
              aut voluptatibus, dolores commodi corporis quibusdam numquam
